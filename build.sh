...
${nuget_cmd} install src/CNXT.Connector.Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/CNXT.Connector.Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/CNXT.Connector.Client.dll \
-recurse:'src/CNXT.Connector.Client/*.cs' \
-doc:bin/CNXT.Connector.Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/CNXT.Connector.Client.dll was created successfully"
fi
