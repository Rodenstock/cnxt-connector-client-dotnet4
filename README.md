...
*PatientsApi* | [**CreatePatient**](docs/PatientsApi.md#createPatient) | **POST** /patients/{id} | Creates a patient.
...
*SessionsApi* | [**CreateSession**](docs/SessionsApi.md#createSession) | **POST** /sessions/{id} | Creates a session which is assigned to an existing patient via Patient id. If the patient does not exist with the given patient id, a new patient is created and the new session is associated accordingly.
