...
{
    /// <summary>
    /// Represents a session or an order
    /// </summary>
    [DataContract]
    public partial class Session :  IEquatable<Session>, IValidatableObject
    {
        ...
        public Session(string id = default(string), string name = default(string), string notes = default(string), StateEnum? state = default(StateEnum?), string patientId = default(string), Patient patient = default(Patient), B2BOptic b2bOptic = default(B2BOptic), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
